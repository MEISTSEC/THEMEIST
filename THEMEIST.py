...
print('\033[1;32m'+"""     This application is meant to be deployed within Kali Linux and will 
    need adjustments in order to fit the penetration testing environment:"""+'\033[1;m')
...
def menu():  
    ...
    ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
            ...
            ___oo____oo____oo_oooo_______oo_oo_oo_oo_oooo_____oo___oo________oo____
            ___oo____oooooooo_oo_________oo__ooo__oo_oo_______oo_____oo______oo____
